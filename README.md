...
This repository contains some of the work I have created using Tableau. The files are ordered chronologically and can be downloaded directly from this repository, as well as be viewed on my [Tableau profile](https://public.tableau.com/profile/roland.rossel#!/) using the links below:
* [01 - SuperStore - Annual Bonus Analysis](https://public.tableau.com/views/P1Superstore-AnnualBonusAnalysis/Sheet1?:language=en-GB&:display_count=y&:origin=viz_share_link)
